namespace sysestoque_CyberKnight
{
    partial class Form_CadastroDeProduto
    {
        ...
        private void InitializeComponent()
        {
            ...
            preço_unitário = new DataGridViewTextBoxColumn();
            ...
            dataGridView1.Columns.AddRange(new DataGridViewColumn[] { id, categoria, qtd_estoque, preço_unitário, descrição, unidade });
            ...
            // qtd_estoque
            // 
            qtd_estoque.HeaderText = "Column1";
            qtd_estoque.Name = "qtd_estoque";
            // 
            // preço_unitário
            // 
            preço_unitário.HeaderText = "preço_unitário";
            preço_unitário.Name = "preço_unitário";
            // 
            // descrição
            // 
        ...
        private DataGridViewTextBoxColumn preço_unitário;
